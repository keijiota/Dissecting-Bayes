function [estimates, log_likelihood] = ML_fit_S50St(Subdata, S50)
% Subdata and S 50 = T trials * M conditions
...
[log_likelihood] = SmaxStrategy(estimates);
    ...
    function [log_likelihood] = SmaxStrategy(params) 
        ...
        for con = 1:4
            ...
            yhut(:,con) = (180 - bias) - S50(:,con) ; 
        end
        
%         var_hut = mean(mean((Subdata - yhut).^2)) ;         
