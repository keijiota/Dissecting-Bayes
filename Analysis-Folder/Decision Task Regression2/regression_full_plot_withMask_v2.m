...
%     if con == 2  ylabel(strcat('Regularized beta by ', regressors(ir)));  end
    ...
    p4 = errorbar(1:nfeatures, avbetaobs, sebetaobs, 's:', 'color', C(ic,:), 'MarkerFaceColor', C(ic,:),'linewidth', 1.5, 'MarkerSize', ms2, 'CapSize',cs);
    
end
legend([p1 p4], {'Simulation of ideal weights','Subjects weights'});
% set(gcf, 'Position', [-200 -200 1360 950]);
