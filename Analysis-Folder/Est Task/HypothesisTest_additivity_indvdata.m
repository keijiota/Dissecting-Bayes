...
for condition = 1:2
    for subi = 1:17
        ...
        subplot(3,6,subi)
        for i = 1:9
            plot(X(i),Y(i), 'ko', 'MarkerFaceColor',[colormap(i,:)/255], 'Markersize',9) ; hold on
        end        
        %         plot(xx, y_h0, 'r-');
        %         plot(xx, y_h1, 'b-');
        %         plot(xx, y_h2, 'g-');
        ...
        xticks(0:0.2:1.3); yticks(0:0.2:1.3);
...
deltaAicc2null_30d = [AICc_h0(:,1) AICc_h1(:,1) AICc_h2(:,1) AICc_h3(:,1) AICc_h4(:,1) AICc_h5(:,1)] - AICc_h0(:,1);
...
deltaAicc2null_5d = [AICc_h0(:,2) AICc_h1(:,2) AICc_h2(:,2) AICc_h3(:,2) AICc_h4(:,2) AICc_h5(:,2)] - AICc_h0(:,2);
evidenceratio_5d = exp((deltaAicc2null_5d - deltaAicc2null_5d(1))/2) ;

meandeltaAicc2null_30d = [mean(AICc_h0(:,1)) mean(AICc_h1(:,1)) mean(AICc_h2(:,1)) mean(AICc_h3(:,1)) mean(AICc_h4(:,1)) mean(AICc_h5(:,1))] - mean(AICc_h0(:,1));
meanevidenceratio_30d = exp((meandeltaAicc2null_30d - meandeltaAicc2null_30d(1))/2) ;
meandeltaAicc2null_5d = [mean(AICc_h0(:,2)) mean(AICc_h1(:,2)) mean(AICc_h2(:,2)) mean(AICc_h3(:,2)) mean(AICc_h4(:,2)) mean(AICc_h5(:,2))] - mean(AICc_h0(:,2));
