...
meandeltaAicc2null_30d = mean(AICc_h0(:,1)) - [mean(AICc_h0(:,1)) mean(AICc_h1(:,1)) mean(AICc_h2(:,1)) mean(AICc_h3(:,1))]; 
meanevidenceratio_30d = exp((meandeltaAicc2null_30d - meandeltaAicc2null_30d(1))/2) ;
meandeltaAicc2null_5d = mean(AICc_h0(:,2)) - [mean(AICc_h0(:,2)) mean(AICc_h1(:,2)) mean(AICc_h2(:,2)) mean(AICc_h3(:,2))];
meanevidenceratio_5d = exp((meandeltaAicc2null_5d - meandeltaAicc2null_5d(1))/2) ;
result2 = [meandeltaAicc2null_30d([1:4])', meandeltaAicc2null_5d([1:4])', meanevidenceratio_30d([1:4])', meanevidenceratio_5d([1:4])'] 
